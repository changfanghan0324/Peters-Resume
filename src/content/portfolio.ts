...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    period: { en: 'July — Present', zh: 'July — Present' },
    ...
    credentials: ['Status: In development', 'Started: July'],
  ...
  },
  {
    ...
    place: { en: 'Independent Project', zh: 'Independent Project' },
    period: { en: 'August — Present', zh: 'August — Present' },
    ...
    credentials: ['Status: In development', 'Started: August'],
  ...
  },
  {
    ...
    place: { en: 'Independent Project', zh: 'Independent Project' },
    period: { en: 'September — Present', zh: 'September — Present' },
    ...
    credentials: ['Status: In development', 'Started: September'],
